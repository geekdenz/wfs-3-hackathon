...
var xmlQuery = require("./node_modules/xml-query/dist");
var XmlReader = require("./node_modules/xml-reader/dist/reader");
...
var $ = jQuery;
var collections = [];
function handleWfsName(event) {
    var that = this;
    var collection = collections.filter(function (c) {
        var child = c.children.filter(function (c) {
            var nameChild = c;
            return c.name == 'Name';
        })[0];
    ...
    var bbox = currentExtent.join(',') + ",EPSG:3857";
    console.log(bbox);
    var link = collection.children[0].attributes.href + "?bbox=" + (bbox) + "&count=30";
    console.log(link);
    fetch(link, {
        headers: {
...
fetch('http://pvretano.com/cubewerx/cubeserv/default/wfs/3.0.0/framework')
    ...
    var xq = xmlQuery(ast).find('Collection');
    xq.map(function (node) {
        var nameNode = node.children.filter(function (n) { return n.name === 'Name'; })[0];
        var titleNode = node.children.filter(function (n) { return n.name === 'Title'; })[0];
        if (nameNode && nameNode.children && nameNode.children.length) {
            var name_1 = nameNode.children[0].value;
            var title = titleNode.children[0].value;
            var link = node.children[0].attributes.href + '?count=100';
            $('#name-list').append($("<li><a href=\"#\" id=\"" + name_1 + "\" class=\"wfs-name\">" + title + "</a> Download: <a target=\"_blank\" href=\"" + link + "\">Data</a></li>"));
...
},{"./node_modules/xml-query/dist":5,"./node_modules/xml-reader/dist/reader":6,"jquery":3}],2:[function(require,module,exports){
'use strict';
